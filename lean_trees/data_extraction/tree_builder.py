...
from lean_trees.core.lean import LeanProofState, LeanTactic
from lean_trees.core.lean_file import LeanFile, LeanTheorem, LeanTacticBlock
from lean_trees.core.proof_tree import ProofTree, ProofTreeNode, ProofTreeEdge
from lean_trees.file_span import FilePosition
from lean_trees.repl_adapter.data import ReplLoadedLeanFile, SingletonProofTree, SingletonProofTreeNode, \
    ReplCompilationUnit
from lean_trees.repl_adapter.interaction import LeanProofBranch, LeanServer
from lean_trees.utils import get_source_with_sorries, replace_with_sorries
...
class ProofTreeBuilder:
    ...
    def run_proof_trees(cls, theorem_str: str, unit: ReplCompilationUnit, env: LeanServer) -> LeanTheorem:
        ...
        init_proof_states = list(env.start_proofs_from_sorries(thm_with_sorries))
