...
from lean_trees.repl_adapter.data import SingletonProofTree, SingletonProofTreeNode, SingletonProofTreeEdge
from lean_trees.file_span import FileSpan
from lean_trees.repl_adapter.ast_parser import LeanASTObject, LeanASTArray
...
class ProofTreePostprocessor:
    ...
    def transform_proof_tree(cls, tree: SingletonProofTree):
        def visitor(node: SingletonProofTreeNode):
            ...
            node.tactic.tactic_string = lean_trees.utils.remove_empty_lines(lean_trees.utils.remove_comments(
