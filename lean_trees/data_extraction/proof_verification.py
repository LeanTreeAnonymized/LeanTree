...
from lean_trees.core.lean_file import LeanTacticBlock, LeanFile
from lean_trees.data_extraction.proof_tree import ProofTreeNode, ProofTree
from lean_trees.environment.interaction import LeanEnvironment, LeanInteractionException, LeanProofBranch
...
class ProofTreeVerifier:
    ...
    def _verify_proofs_in_file(self, file: LeanFile, env: LeanEnvironment) -> list[tuple[LeanTacticBlock, str]]:
        ...
        for by_block, init_proof_state in env.start_file_proofs(file):
            debug_infos = [
                f"in file: {file.path}",
    ...
    def _verify_theorem_proof(self, theorem_with_sorry: str, proof: ProofTree, env: LeanEnvironment):
        init_states = list(env.start_proofs_from_sorries(theorem_with_sorry))
