...
# TODO: rename to StringPosition
# TODO: maybe nuke this class
...
class FilePosition:
    ...
    @classmethod
    def beginning_of_file(cls) -> "FilePosition":
        return cls(0)

    @classmethod
    def end_of_file(cls, content: str) -> "FilePosition":
        return FilePosition(len(content))

    def relative_to(self, origin: "FilePosition") -> "FilePosition":
        return FilePosition(self.offset - origin.offset)

    def __lt__(self, other: "FilePosition"):
        if not isinstance(other, FilePosition):
            return NotImplemented
        return self.offset < other.offset

    def __gt__(self, other: "FilePosition"):
        if not isinstance(other, FilePosition):
            return NotImplemented
        return self.offset > other.offset

    def __le__(self, other: "FilePosition"):
        if not isinstance(other, FilePosition):
            return NotImplemented
        return self.offset <= other.offset

    def __ge__(self, other: "FilePosition"):
        if not isinstance(other, FilePosition):
            return NotImplemented
        return self.offset >= other.offset

    def __cmp__(self, other: "FilePosition"):
        if not isinstance(other, FilePosition):
            return NotImplemented
