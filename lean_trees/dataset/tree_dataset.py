...
from lean_trees.core.lean_file import LeanFile, StoredError
from lean_trees.core.project import LeanProject, LeanTheorem
...
def create_parser():
    ...
    generate.add_argument("--project_path", type=Path, default="/home/kripner/troja/arcoss-lean-repo-v4-19-rc2")
    generate.add_argument("--source_files", type=Path, default="mathlib/Mathlib")
    generate.add_argument("--output_dir", type=Path, default="/home/kripner/troja/project_1/data/datasets/lean/trees")
    # TODO: remove default!!
    generate.add_argument("--repl_exe", type=Path, default="/home/kripner/repos/lean-repl-fork/.lake/build/bin/repl")
    ...
    generate.add_argument("--total_workers", type=int, default=128)
    generate.add_argument("--worker_id", type=int, required=True)
    ...
    # TODO: remove the defaults
    view_stats.add_argument("--project_path", type=Path, default="/home/kripner/troja/arcoss-lean-repo-v4-19-rc2")
    ...
    merge_shards.add_argument("--output_dir", type=Path, default="/home/kripner/troja/project_1/data/datasets/lean/trees")
    merge_shards.add_argument("--shards_count", type=int, default=64)
...
class DatasetGenerator:
    def __init__(self, args, out_path: Path, errors_path: Path):
        ...
        self.project = LeanProject(args.project_path)
    ...
    def load_file(self, path: Path):
        ...
        return self.project.load_file(
            ...
            logger=self.logger,
            repl_exe_path=self.args.repl_exe,
        )
